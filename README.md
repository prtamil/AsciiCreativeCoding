...
| `raster/` + `raymarcher/` | 13 | SDF raymarcher (Blinn-Phong, shadow rays, primitives, smooth-union gallery); Mandelbulb explorer + rasterizer; UV torus / cube / sphere / displacement raster; Bresenham wireframe; donut; volumetric `nuke` mushroom cloud (2-D axisymmetric Stam stable fluids); `sun` solar SDF |
