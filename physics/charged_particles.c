 ...
 *                  the particles off the screen. SOFTENING (`r² := max(r²,
 * R_SOFT²)`) prevents the singularity at r → 0 from producing infinite force
 * when two opposite-charge particles approach each other closely.
 *
