...
/* ═══════════════════════════════════════════════════════════════════════ */
/* §4  formula — tetrakis (wedge classifier + barycentric per wedge)       */
/* ═══════════════════════════════════════════════════════════════════════ */
...
static void pool_toggle(ObjectPool *p, int col, int row, int dir, char glyph)
{
    int idx = pool_find(p, col, row, dir);
    ...
    while (g_running) {
        ...
        while ((ch = getch()) != ERR) {
            switch (ch) {
                ...
                case ' ': pool_toggle(&pool, cur.col, cur.row, cur.dir, GLYPHS[cur.glyph_idx]); break;
